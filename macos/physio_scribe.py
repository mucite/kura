...
{{"""
    ...
    def recover_hard_metrics(self, transcript, soap_dict, profile_id: str = "KG"):
        ...
        # Recover fall risk (near-fall events)
        ...
        # Recover ZNS-specific gait (foot drop)
